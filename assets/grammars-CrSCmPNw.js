...
import { r as requirePathBrowserify, a as requireLib, _ as __vitePreload } from "./index-1FCrfK0n.js";
var dist = {};
var main$1 = {};
var registry = {};
var grammar = {};
...
function requireRule() {
  ...
  hasRequiredRule = 1;
  var __extends = rule && rule.__extends || function() {
...
function requireDebug() {
  ...
  debug.CAPTURE_METADATA = typeof process === "undefined" ? false : !!define_process_env_default["VSCODE_TEXTMATE_DEBUG"];
  debug.IN_DEBUG_MODE = typeof process === "undefined" ? false : !!define_process_env_default["VSCODE_TEXTMATE_DEBUG"];
  return debug;
}
...
function requireGrammar() {
  ...
  var utils_1 = requireUtils();
  var rule_1 = requireRule();
  var matcher_1 = requireMatcher();
  ...
  var SyncRegistry = (
    ...
    function() {
      ...
      SyncRegistry2.prototype.addGrammar = function(grammar2, injectionScopeNames) {
        ...
        var includedScopes = {};
        grammar_1.collectIncludedScopes(includedScopes, grammar2);
        if (injectionScopeNames) {
...
var hasRequiredGrammarReader;
function requireGrammarReader() {
  if (hasRequiredGrammarReader) return grammarReader;
  hasRequiredGrammarReader = 1;
  Object.defineProperty(grammarReader, "__esModule", { value: true });
  var plist = requireMain$1();
  var debug_1 = requireDebug();
...
function requireMain() {
  ...
  hasRequiredMain = 1;
  var __awaiter = main$1 && main$1.__awaiter || function(thisArg, _arguments, P, generator) {
  ...
  var __generator = main$1 && main$1.__generator || function(thisArg, body) {
  ...
  var grammarReader_1 = requireGrammarReader();
  var theme_1 = requireTheme();
  var grammar_1 = requireGrammar();
  var DEFAULT_OPTIONS = {
  ...
  main$1.Registry = Registry;
  main$1.INITIAL = grammar_1.StackElement.NULL;
  return main$1;
}
var tmToMonacoToken = {};
var hasRequiredTmToMonacoToken;
function requireTmToMonacoToken() {
  if (hasRequiredTmToMonacoToken) return tmToMonacoToken;
  hasRequiredTmToMonacoToken = 1;
...
function requireDist() {
  ...
  dist.wireTmGrammars = void 0;
  const monaco_textmate_1 = requireMain();
  const tm_to_monaco_token_1 = requireTmToMonacoToken();
  ...
  dist.wireTmGrammars = wireTmGrammars;
  return dist;
}
...
async function dispatchGrammars(scopeName) {
  switch (scopeName) {
    case "source.vue":
      return {
        format: "json",
        content: await __vitePreload(() => import("./vue.tmLanguage-CkACCoPE.js"), true ? [] : void 0)
      };
    case "source.ts":
      return {
        format: "json",
        content: await __vitePreload(() => import("./typescript.tmLanguage-CnwbcJXa.js"), true ? [] : void 0)
      };
    case "source.js":
      return {
        format: "json",
        content: await __vitePreload(() => import("./javascript.tmLanguage-BbBCHHaD.js"), true ? [] : void 0)
      };
    case "text.html.basic":
      return {
        format: "json",
        content: await __vitePreload(() => import("./html.tmLanguage-BnJfE3Yj.js"), true ? [] : void 0)
      };
    case "source.css":
      return {
        format: "json",
        content: await __vitePreload(() => import("./css.tmLanguage-BlTDgn2A.js"), true ? [] : void 0)
      };
    default:
      return {
        format: "json",
...
async function loadGrammars(monaco, editor) {
  const registry2 = new mainExports.Registry({
  ...
  await distExports.wireTmGrammars(monaco, registry2, grammars, editor);
}
export {
  loadGrammars
};
